...
static const char COMPACT_SYSTEM_PROMPT[] =
    ...
    "## User Preferences\n"
    "Corrections, style preferences, workflow habits. Keep indefinitely.\n\n"
    "## Learnings\n"
    "Non-obvious discoveries about the codebase, tools, or environment. "
    "Drop once the underlying code changes.\n\n"
    "## Errors & Fixes\n"
    "Recurring problems and their resolutions. Keep patterns, drop one-offs.\n\n"
    "## Key Results\n"
    "Deliverables produced, milestones reached. Compress over time.\n\n"
    "Compaction rules:\n"
    ...
    "4. Reorganize entries into the sections above based on content, regardless "
    "of their original location. Entries tagged with [state], [decision], "
    "[error], [learning], [user], [result], [blocked] map to the matching "
    "section.\n"
    ...
    "7. If the file is already compact enough, return it unchanged but still "
    "reorganized into the section structure.\n"
