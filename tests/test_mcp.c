...
static void test_mcp_client_lifecycle(void)
{
    ...
    sc_mcp_client_t *client = sc_mcp_client_start("mock", cmd, 2, NULL, NULL, 0, NULL, NULL);
...
static void test_mcp_server_not_found(void)
{
    ...
    sc_mcp_client_t *client = sc_mcp_client_start("bad", cmd, 1, NULL, NULL, 0, NULL, NULL);
    ASSERT_NULL(client);
}
...
static void test_mcp_server_crash(void)
{
    ...
    sc_mcp_client_t *client = sc_mcp_client_start("crash", cmd, 2, NULL, NULL, 0, NULL, NULL);
    ASSERT_NOT_NULL(client);
